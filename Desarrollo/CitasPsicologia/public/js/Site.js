                ...
                u || s[d].push(l), l.eX = l.eY = 0, function (e, c) {
                    e.addEventListener("scroll", e.syn = function () {
                        ...
                        for (f != e.eX && (v = 1, e.eX = f), h != e.eY && (E = 1, e.eY = h), u = 0; u < d.length; u++)
                            l = d[u], l != e && (v && (f = Math.round(p * (l[i + t] - l[a + t])), l.eX = l[i + r] = f), E && (h = Math.round(m * (l[i + n] - l[a + n])), l.eY = l[i + o] = h))
                    }, 0)
                }(l, d)
            }
    };
...
Timetable.Renderer = function (e) {
    ...
    Timetable.prototype = {setScope: function (t, n) {
            if (!e(t, n))
        ...
        }}, Timetable.Renderer.prototype = {draw: function (e) {
            function t(e) {
                if (null === e)
            ...
            function o(e) {
                for (var t = 0; t < m.locations.length; t++) {
                    var n = e.appendChild(document.createElement("li")), o = n.appendChild(document.createElement("span"));
                    o.className = "row-heading", o.textContent = m.locations[t]
                }
            }
            function r(e) {
                var t = e.appendChild(document.createElement("section")), n = i(t), o = t.appendChild(document.createElement("time"));
            ...
            function i(e) {
                ...
                for (var n = t.appendChild(document.createElement("ul")), o = !1, r = !1, i = m.scope.hourStart; !o; ) {
                    var a = n.appendChild(document.createElement("li")), s = a.appendChild(document.createElement("span"));
            ...
            function d(e, t) {
                ...
                var s = n ? "a" : "span", c = t.appendChild(document.createElement(s)), l = c.appendChild(document.createElement("small"));
