...
class RegisterAppointmentOutsideTest {

    public function testRegisterAppointmentOutside() {       
    ...
    public function testRegisterFunctionaryOutside() {
        $model = AppointmentModel::singleton();
        $resultado = $model->register_functionary(
                ...
                "beto@gmail.com", "321", "2022-12-06", "nada", "nada",
                "central", "2019-12-06");        
        print_r($resultado);
    }
